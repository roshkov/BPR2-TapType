...
uint8_t newLayout[8] = {0}; //receiving message from other keyboard if layout is changed
...
//void checkForLayoutChangeCallFromOtherKeyboard() {
//
//  if (Serial1.available() > 0) {
//      int x = (Serial1.read() >> (8*7)) & 0xff;
//      pageSetup = x;
//  }
//}
...
//checkForLayoutChangeCallFromOtherKeyboard();
